...
import { FaqslistService } from './faqslist.service';
import { HttpClient, HttpErrorResponse } from '@angular/common/http';

describe('FaqslistService', () => {
  ...
  it('should fetch the faqs data', () => {
    ...
    service.getFAQSList().subscribe((data) => {
      expect(data).toBeDefined();
    });
  });

  it('should catch the error response', () => {
